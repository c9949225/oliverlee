...
//    private Image newCopyImages;
    ...
    public TempShell(Composite composite,Image bi){
    	...
    	clipboard = new Clipboard(getDisplay());
    	 /*try {
         	FileInputStream imageIo=new FileInputStream("image/icon/backImage.gif");
 			bagground=new Image(getDisplay(),imageIo);
 			imageIo=new FileInputStream("image/icon/sucssefull.gif");
 			copyImages=copyImage=new Image(getDisplay(),imageIo);
 			imageIo=new FileInputStream("image/icon/Revocation.gif");
 			cleanImages=cleanImage=new Image(getDisplay(),imageIo);
 			imageIo=new FileInputStream("image/icon/save.gif");
 			saveImages=saveImage=new Image(getDisplay(),imageIo);
 			imageIo=new FileInputStream("image/icon/saves.gif");
 			newSaveImages=new Image(getDisplay(),imageIo);
 			imageIo=new FileInputStream("image/icon/Revocations.gif");
 			newCleanImages=new Image(getDisplay(),imageIo);
 			imageIo=new FileInputStream("image/icon/sucssefulls.gif");
 			newCopyImages=new Image(getDisplay(),imageIo);
 		} catch (IOException e) {
 			e.printStackTrace();
 		}*/
