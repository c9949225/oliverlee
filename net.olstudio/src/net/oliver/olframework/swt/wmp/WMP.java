...
//          setLayout(layout);
        ...
        {   
            ...
            // 第三个参数是注册表中ProgID键的值，比如Word的就是Word.Document.6
            controlSite = new OleControlSite(frame, SWT.NO_TRIM, "WMPlayer.OCX.7");  // IE的VersionIndependentProgID是Shell.Explorer 在注册表中指定 
        ...
        // 根据前面的controlSite创建oleautomation,这样就可以调用控件的属性和方法
