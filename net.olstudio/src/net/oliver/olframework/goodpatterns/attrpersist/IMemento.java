 ...
 *******************************************************************************/
package net.oliver.olframework.goodpatterns.attrpersist;

/**
 * 用来将一个对象的重要状态持久化保存为一个表单到文件系统。
 * 
 ...
 * 被设计用来做以下事情:
 * <ol>
 * <li>一些对象需要被保存并回复在整个平台会话周期。</li>
 * <li>Certain objects need to be saved and restored across platform sessions.</li>
 * <li>当一个对象被恢复，一个可用的类可能找不到，这种情况下必须被略过</li>
 * <li>When an object is restored, an appropriate class for an object might not
 * be available. It must be possible to skip an object in this case.</li>
 * <li>当一个对象被恢复，可用的类可能与最初保存的对象不同，如果这样的话，新的类必须
 * 仍然可以读旧的类的数据。</li>
 ...
 * </p>
 * <p>
 * Mementos通过将任意的字符串KEY到原始数据类型，运行mementos拥有其他mementos作为
 * 孩子，健全的XML保存机制来支持上面的需求</p>
 *  <p>
