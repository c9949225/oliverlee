 ...
 *******************************************************************************/
package net.oliver.olframework.goodpatterns.uri;

// 不透明 URI 为绝对 URI，其特定于方案的部分不是以斜线字符 ('/') 开始。
// 不透明 URI 无法进行进一步解析。下面是不透明 URI 的一些示例： 
...
//根据基本 URI http://java.sun.com/j2se/1.3/ 解析， 
...
/**
 * 操作URI的工具类。该类解决一些java.net.URI不想要的行为，并且提供额外的路径操作方法。
 * 
