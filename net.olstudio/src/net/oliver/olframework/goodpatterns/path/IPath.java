 ...
 *******************************************************************************/
package net.oliver.olframework.goodpatterns.path;
...
public interface IPath extends Cloneable {
	...
	/**
	 * 传入一个基路径，返回和本路径相同的，但是如果可能的话是相对于传入的基路径
	 * 
