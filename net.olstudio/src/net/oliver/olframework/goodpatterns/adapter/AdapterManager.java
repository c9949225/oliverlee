...
public final class AdapterManager implements IAdapterManager {
	...
	// 延迟facotry提供器，在使用factories之前调用，向本manager添加facotories
	...
	/**
	 * 将适配器查找路径刷空。当一个adapter被添加或移除的时候被调用。
	 * 
