 ...
 *******************************************************************************/
package net.oliver.olframework.goodpatterns.adapter;

/**
 * 维护adapter factory的注册表。客户可直接调用adapter manager的方法来注册和取消注册adapter
 * 
 ...
 * adapter manager 将请求发送到IAdapterFactory.getAdapter
 ...
 * <p>
 * adapter factories可以直接使用registerAdapters方法进行注册，也可以使用扩展点的方式。
