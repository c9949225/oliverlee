/**
 * Copyright 1993-2007 Agree Tech.
 * All rights reserved.
 */
package net.oliver.olframework.util.encoding;
 ...
 * @version $Id: Base64.java,v 1.1 2007/08/27 13:40:59 puyun Exp $
 */
public class Base64
{
     ...
     * 
     * <p>
     * The {@value} character limit does not count the trailing CRLF,
     ...
     * requirements on page 25 of RFC 2045 - "Any characters outside
     * of the base64 alphabet are to be ignored in base64 encoded
     * data."
     * 
     * @param data
    ...
    static byte[] discardNonBase64(byte[] data)
    {
        ...
        System
                .arraycopy(groomedData, 0, packedData, 0,
                        bytesCopied);
     ...
     * @param isChunked
     *            if isChunked is true this encoder will chunk the
            ...
            boolean isChunked)
    {
        ...
        for (i = 0; i < numberTriplets; i++)
        {
            ...
            if (isChunked)
            {
                ...
                {
                    System.arraycopy(CHUNK_SEPARATOR, 0,
    ...
    /**
     * Tests a given byte array to see if it contains only valid
     * characters within the Base64 alphabet.
     * 
     * @param arrayOctect
     *            byte array to test
    ...
    /**
     * Encodes a byte[] containing binary data, into a byte[]
