 ...
 * @version $Revision: 1.1.2.1 $ $Date: 2009/04/22 13:05:23 $
 */
    ...
    public synchronized void load(InputStream inStream) throws IOException
    {
        ...
        while (true)
        {
            ...
            if (line.length() > 0)
            {
                // Find start of key
                int len = line.length();
                int keyStart; // oliver at 2009-8-19 上午11:01:15 :  找到非空白开始的地方
                for (keyStart = 0; keyStart < len; keyStart++)
                    if (whiteSpaceChars.indexOf(line.charAt(keyStart)) == -1)
                        break; // oliver at 2009-8-19 上午11:05:32 : 这里break的是for loop
                ...
                if ((firstChar != '#') && (firstChar != '!')) // oliver at 2009-8-19 上午11:06:23 : 如果是非注释
                {
